...
export default function BlogPage() {
  ...
  return (
    <>
          ...
          {filteredArticles.length === 0 ? (
            ...
            <div className="blog-3col-grid">
              {filteredArticles.map((article) => (
                <article key={article.slug} className="modern-card reveal-on-scroll">
                  <div>
                    <div style={{
                      display: 'flex',
                      justifyContent: 'space-between',
                    ...
                    <h4 style={{ fontSize: '1.2rem', marginBottom: 10, color: 'var(--text-heading)', lineHeight: 1.35 }}>
      ...
      {/* CMS Publishing Workflow Callout */}
      <section className="modern-section bg-surface">
        <div className="rc-container">
          <div style={{
            backgroundColor: 'var(--bg-subtle)',
            border: '1px solid var(--border-subtle)',
            ...
            <div>
              <span className="rc-badge" style={{ marginBottom: 8 }}>CMS Ready Architecture</span>
              <h3 style={{ fontSize: '1.35rem', color: 'var(--text-primary)', marginTop: 8, marginBottom: 6 }}>
                Desktop & Mobile Publishing Workflow
              </h3>
              <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', maxWidth: 650 }}>
                Experience the visual publishing interface designed for regular article creation, live previews, and scheduling across desktop and smartphones.
              </p>
            </div>
            <Link href="/admin-blog" className="btn-modern-primary">
              <span>Open Admin Workflow</span>
              <ArrowRight size={16} />
            </Link>
          </div>
        </div>
